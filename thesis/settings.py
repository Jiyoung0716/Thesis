...
import os # 토클 & 키 세팅 (Secure / Insecure version)
...
ENCRYPTION_ENABLED = True   # ← 암호화 모드
# ENCRYPTION_ENABLED = False  # ← 평문 모드

AWS_REGION = "us-east-1"
DDB_TABLE_SIGNUPS = "thesis-signups"
...
INSTALLED_APPS = [
    ...
    'experiment', # 개인정보 입력 / 저장 / 조회 기능 구현 (QWASP ZAP 공격 테스트 대상)
]
...
# 개발 시: BASE_DIR/static 폴더 사용
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]

# collectstatic 결과물이 모이는 곳 (EB 배포용)
